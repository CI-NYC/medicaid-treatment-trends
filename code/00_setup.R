...
drv_root <- "/home/amh2389/medicaid/plotting_trends/results"
...
cohort <- cohort[, .(BENE_ID, washout_start_dt, washout_12mos_end_dt, dem_race_cond, disability_pain_12mos_cal)]
setkey(cohort, BENE_ID)
