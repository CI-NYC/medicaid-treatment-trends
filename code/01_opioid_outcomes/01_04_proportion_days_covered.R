...
dts_cohorts <- dts_cohorts[dts_cohorts$opioid_pain_washout_12mos_cal == 1, c("BENE_ID", "washout_cal_end_dt")]

otl <- readRDS(file.path(save_dir, "trends_otl_opioid_pain_rx.rds"))

rxl <- readRDS(file.path(save_dir, "trends_rxl_opioid_pain_rx.rds"))
