...
```{r}
analysis_cohort <- readRDS("/mnt/general-data/disability/create_cohort/final/analysis_cohort.rds")
setDT(analysis_cohort)
# analysis_cohort <- analysis_cohort[, .(BENE_ID, washout_cal_end_dt)]
setkey(analysis_cohort, BENE_ID)

# analysis_cohort <- analysis_cohort[, c("BENE_ID",
#                                        "washout_start_dt",
#                                        # "washout_cal_end_dt",
...
saveRDS(results, file.path("/home/amh2389/medicaid/plotting_trends/results", "additional_outcomes_results.rds"))
# results <- readRDS(file.path(save_dir, "additional_outcomes_results.rds"))
...
```{r}
results <- readRDS(file.path(drv_root, "additional_outcomes_results.rds"))
library(ggplot2)
